...
return [
    ...
    'nglayouts_rule' => [
        ...
        ['id' => 8, 'status' => 1, 'uuid' => 'b8ae8e19-e127-49e7-be95-33adf07ce4da', 'rule_group_id' => 1, 'layout_uuid' => 'e2616d99-6f74-4201-a1f0-04fb08f41746', 'description' => ''],
        ['id' => 9, 'status' => 1, 'uuid' => '67d1e6de-7460-42de-92ca-ab3523f6b71a', 'rule_group_id' => 1, 'layout_uuid' => '11d041dd-fe70-4677-bfcd-3788644c02af', 'description' => ''],
    ],
    'nglayouts_rule_data' => [
        ['rule_id' => 1, 'enabled' => 1, 'priority' => 9],
        ['rule_id' => 2, 'enabled' => 1, 'priority' => 8],
        ['rule_id' => 3, 'enabled' => 1, 'priority' => 7],
        ['rule_id' => 4, 'enabled' => 1, 'priority' => 6],
    ...
    'nglayouts_rule_target' => [
        ...
        ['id' => 7, 'status' => 1, 'uuid' => '66dfc4ba-aaac-4a98-b64a-978d88b776ec', 'rule_id' => 4, 'type' => 'sylius_taxon_tree', 'value' => 2],
        ['id' => 8, 'status' => 1, 'uuid' => '5151d29a-9a50-4a70-ad0c-6a08c7d0feb7', 'rule_id' => 4, 'type' => 'sylius_taxon_tree', 'value' => 43],
        ['id' => 9, 'status' => 1, 'uuid' => '69b5c0bd-3275-45dc-8d84-e389f511d1c4', 'rule_id' => 5, 'type' => 'sylius_taxon_tree', 'value' => 5],
        ['id' => 10, 'status' => 1, 'uuid' => '3364f6ab-2774-43bb-b837-3556f348ae34', 'rule_id' => 5, 'type' => 'sylius_taxon_tree', 'value' => 13],
        ...
        ['id' => 17, 'status' => 1, 'uuid' => '1c9d74c0-91c6-48d3-aa5c-ad5f2573d6d6', 'rule_id' => 8, 'type' => 'sylius_taxon', 'value' => 2],
        ['id' => 18, 'status' => 1, 'uuid' => '4e9da1f6-1ecc-4ebc-a5df-a7ffb43e0bac', 'rule_id' => 8, 'type' => 'sylius_taxon', 'value' => 43],
        ['id' => 19, 'status' => 1, 'uuid' => '356a79f4-1132-4be9-a3c9-9307d27186a1', 'rule_id' => 9, 'type' => 'sylius_taxon', 'value' => 8],
        ['id' => 20, 'status' => 1, 'uuid' => '05508940-501b-42ed-9e41-0a2c5770696e', 'rule_id' => 9, 'type' => 'sylius_taxon', 'value' => 13],
    ],
];
